const countries = [
  ...
  },
  {
    ...
    languages: [
      { iso639_1: 'en', iso639_2: 'eng', name: 'English', nativeName: 'English' },
      { iso639_1: 'to', iso639_2: 'ton', name: 'Tonga (Tonga Islands)', nativeName: 'faka Tonga' },
    ],
    translations: {
      de: 'Tonga',
      es: 'Tonga',
...
// 1. Write fn that accepts two params: array of countries and region.
//    Fn should return  array of countries of passed region.

// 2. Write fn that accepts two params: array of countries and currency.
//    Fn should return  array of countries that have such currency in use.

// 3. Write fn that accepts two params: array of countries and capital.
//    Fn should return  country with desired capital.

// 4. Write fn that accepts array of countries and order of sorting (ascendind, descending).
//    Fn should return array sorted by poplation.
